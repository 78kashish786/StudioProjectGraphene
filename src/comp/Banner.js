...
const Banner = (props) => {
  return (
    <div className='text-white bg-[#121211]   md:h-[555px]   overflow-hidden md:px-16 px-4 py-20  h-screen'>
        <div className='flex flex-col  md:gap-5 gap-0  md:-my-10  mt-[250px]' >
          <h1 className='typos-md text-[45px] md:text-[90px]   z-10' >Fresh</h1>
          <img className='h-[30%] w-[50%]  md:ml-[200px] ml-[150px] z-10' src={images} alt='2022'/>
